...
unann_blast <- fread("output/deseq2/tissue_itWT_LRT/unann_degs/interaction_nr_blastx.outfmt6")
...
unann_blast_no_hypo <- subset(unann_blast, !grepl("uncharacter|hypothetical|unnamed|unknown", annotation, ignore.case = TRUE))
...
fwrite(min_evalues, "output/deseq2/tissue_itWT_LRT/unann_degs/min_evalues.csv")
