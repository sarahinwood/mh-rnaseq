...
signalp_blast <- fread("output/04_blast/venom_signalp/venom_signalp_nr_blastx.outfmt6")
...
##write table
fwrite(min_evalues, "output/04_blast/venom_signalp/venom_signalp_besthits.csv")

venom_degs <- fread("output/03_deseq2/tissue_itWT/Venom/Venom_sp_all_annots.csv")
all_res <- merge(venom_degs, min_evalues, by="transcript_id", all=T)
fwrite(all_res, "output/03_deseq2/tissue_itWT/Venom/Venom_sp_sigp_blast.csv")
