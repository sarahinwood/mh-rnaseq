...
viral_genes_blast_res <- fread("output/blast/viral_genes/blastn.outfmt6")
...
##write table
fwrite(min_evalues_all_annots, "output/blast/viral_genes/viral_genes_best_hits.csv")
...
fwrite(prodigal_recip_annots_simple, "output/blast/viral_genes/viral_genes_recip_DaFV_LbFV.csv")
...
fwrite(prodigal_recipv_annots_simple, "output/blast/viral_genes/viral_genes_recip_all_viral.csv")
