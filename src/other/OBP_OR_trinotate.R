...
chemosensory_degs <- fread("output/deseq2/tissue_itWT_LRT/head/chemosensory/chemosensory_lrt_degs.csv")
...
tissue_colours <- list(Tissue = c(Head="#231151FF", Thorax="#5F187FFF", Abdomen="#982D80FF", Ovaries="#D3436EFF", Venom="#F8765CFF"),
                       Label = c(GR="#30123BFF", IR="#28BBECFF",  OBP="#A2FC3CFF", OR="#FB8022FF", SNMP="#7A0403FF"))
