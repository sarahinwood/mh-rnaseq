...
fwrite(list(venom_specific_DEGs), "output/deseq2/itWT/venom_itWT/mh_venom_specific_degs.txt")

venom_sp_annots <- subset(trinotate, `#gene_id` %in% venom_specific_DEGs)
fwrite(venom_sp_annots, "output/deseq2/itWT/venom_itWT/venom_sp_annots.csv")
